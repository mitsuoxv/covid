...
states_map %>% 
  left_join(states_speed, by = c("iso_3166_2" = "state_abb")) %>% 
  ggplot() +
...
states_map %>% 
  left_join(states_speed_std, by = c("iso_3166_2" = "state_abb")) %>% 
  ggplot() +
...
states_map %>% 
  left_join(states_fatality, by = c("iso_3166_2" = "state_abb")) %>% 
  ggplot() +
...
states_map %>% 
  left_join(states_deaths, by = c("iso_3166_2" = "state_abb")) %>% 
  ggplot() +
