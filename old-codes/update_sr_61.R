...
# Specify FILE
FILE <- "20200321-sitrep-61-covid-19.pdf"
...
area_cat <- tibble(
  ...
  cat = c(
    rep("China", 1),
    rep("South East Asia, excl China", 16),
    rep("Europe", 59),
    rep("South East Asia, excl China", 9),
    rep("Eastern Mediterranean", 19),
    rep("Americas", 44),
    rep("Sub-Saharan Africa", 34),
...
# Saint Vincent and the Grenadines
# Was this the missing 1 yesterday? I think so
# I add to table2
temp <- tibble(
  publish_date = as.Date("2020-01-20"),
