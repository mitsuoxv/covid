...
# Specify FILE
FILE <- "20200324-sitrep-64-covid-19.pdf"
...
df_table2[(df_table2$area == "Saint Vincent and th"), ]

df_table2[(df_table2$area == "Saint Vincent and th"), "area"] <- 
