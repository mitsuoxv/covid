...
# Specify FILE
FILE <- "20200408-sitrep-79-covid-19.pdf"
...
df_table2[(df_table2$area == ""), "area"] <- "Palestine"
...
df_table2[(df_table2$area == "Saint Kitts and Nevi"), ]
df_table2[(df_table2$area == "Saint Kitts and Nevi"), "area"] <- "Saint Kitts and Nevis"

df_table2[(df_table2$area == "British Virgin Islan"), ]
df_table2[(df_table2$area == "British Virgin Islan"), "area"] <- "British Virgin Islands"
