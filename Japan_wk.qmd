...
df_table_0519 <- read_pdf("https://www.mhlw.go.jp/content/001100553.pdf")
df_table_0526 <- read_pdf("https://www.mhlw.go.jp/content/001100720.pdf")

# add pdf data
in_japan_wk <- bind_rows(in_japan_wk, df_table_0519, df_table_0526)
```

## Weekly confirmed cases per hospital

```{r}
#| label: conf_per_hospital
